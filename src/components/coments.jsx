    ...
    <div className="coment">
      {!editMode ? (
        <>
          ...
          <p className="coment-info">
            {new Date(coment.timestamp).toLocaleString()}
          </p>
        </>
      ) : (
      ...
      <div className="comment-actions">
        <button onClick={toggleExpand} className="coment-button">
          {expand ? "Hide Replies" : "Reply"}
        </button>
        <button className="coment-button" onClick={toggleEditMode}>
          Edit
        </button>
        <button className="coment-button" onClick={handleDelete}>
          Delete
        </button>
      </div>
      {expand && (
